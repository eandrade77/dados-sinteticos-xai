...
class googleimagesdownload:
    ...
    def download_extended_page(self, url, chromedriver):
        ...
        #browser.get('https://www.bing.com/images/search?q=doberman')
        time.sleep(0.5)
    ...
    # make directories
    def create_directories(self, main_directory, dir_name, url):
        ...
        try:
            if not os.path.exists(main_directory):
                ...
                if not os.path.exists(sub_directory):
                    ...
                    with open("images/queries.txt", "a+") as file_object:
                        ...
                        if len(data) > 0 :
                            ...
                            print(url)
                            file_object.write(url +",'"+sub_directory+"'")
            else:
                path = (dir_name)
                sub_directory = os.path.join(main_directory, path)
                if not os.path.exists(sub_directory):
            ...
            for sky in suffix_keywords:  # 2.for every suffix keywords
                ...
                while i < len(search_keyword):  # 3.for every main keyword
                    ...
                    if arguments["download"]:
                        self.create_directories(main_directory, dir_name, arguments['url'])  # create directories in OS
                    ...
                    if arguments['related_images']:
                        ...
                        for key, value in tabs.items():
                            ...
                            self.create_directories(main_directory, final_search_term, arguments['url'])
